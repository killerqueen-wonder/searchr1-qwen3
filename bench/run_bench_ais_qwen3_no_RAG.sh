...
# [核心变更]：开启纯 API 直连模式，屏蔽 RAG 与 总结 流程
...
export MODEL_NAME="${MODEL_NAME:-qwen3-8b-no-RAG-0518}"
...
# 保留占位变量以防下层 argparse 强校验报错，但实际因 USE_DIRECT_API 不会被触发
...
# ================= 3. 启动后台服务 (2xA800 模式) =================
info "========================================================="
info " 🚀 全量 Bench 自动化评测启动 (Direct API / 2xA800 模式)"
info " 工作目录: ${BASE_DIR}"
info "========================================================="
...
python ${BASE_DIR}/searchr1-qwen3/bench/ucl/ucl_infer.py \
    ...
    --max_turn 12 --topk 10 --workers ${WORKERS}
