...
if __name__ == '__main__':
    ...
    prompt = (
        ...
        "思考：每次获得新信息后，你必须首先在 <think> 和 </think> 标签内进行推理。推理过程中，如果你发现涉及某些法律条文，则进入检索步骤。\n"
        ...
        "再次思考：搜索结果是否有助于解决问题？如果没有帮助，则回到上一步，修改关键词再次搜索。你可以根据需要进行多次搜索，直到检索到最适合的法条。如果基于先前的思考和检索结果，你已经有把握得到最终答案，进入下一步回答。\n"
