...
export BASE_MODEL="/F00120250029/panghuaiwen/legal_LLM/SFT_ckp/qwen3_SFT_10k_DISC_10k_crime/checkpoint-2-3522/tfmr"
export EXPERIMENT_NAME=legal_exam-search-r1-ppo-qwen3-8b-SFT_10k_DISC_10k_crime_2
...
PYTHONUNBUFFERED=1 python3 -m verl.trainer.main_ppo \
    ...
    data.max_prompt_length=11500 \
    data.max_response_length=2300 \
    +data.max_start_length=1000 \
    +data.max_obs_length=900 \
