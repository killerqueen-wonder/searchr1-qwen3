...
export DATA_DIR="/caizhenyang/panghuaiwen/legal_LLM/dataset/dataset/DISC_RL"
...
export BASE_MODEL="/F00120250029/panghuaiwen/legal_LLM/RL_ckp/legal_exam-search-r1-ppo-qwen3-8b-SFT_10k_DISC_10k_crime_em/global_step_100/actor_merge"
export EXPERIMENT_NAME=legal_exam-search-r1-ppo-qwen3-8b-SFT_RL_reward_test
