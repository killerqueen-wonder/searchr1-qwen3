...
# 适用环境：4 x A800 (80GB)
# 修改方案：后台服务独占 GPU 3，训练独占 GPU 0, 1, 2
# ==============================================================================
...
export EXPERIMENT_NAME=legal_exam-ppo-qwen3-8b-RL-7.4-A800-fp8-lora
...
# ==================== 3. 启动主训练任务 (使用 GPU 0,1,2) ====================
info "======================================================"
info "架构启动完毕，正式开始 GRPO LoRA 强化学习训练 (GPU 0,1,2)！🚀"
info "======================================================"
